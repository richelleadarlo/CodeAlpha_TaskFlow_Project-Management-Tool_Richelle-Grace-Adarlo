    ...
    <div className="min-h-screen px-4 py-6 sm:px-6 sm:py-10">
      <div className="mx-auto max-w-6xl">
        ...
        <main className="grid grid-cols-1 gap-4 lg:grid-cols-4">
          <section className="bento-card relative overflow-hidden p-6 lg:col-span-3 lg:row-span-2">
          ...
          <aside className="bento-card p-5 lg:col-span-1">
          ...
          <article className="bento-card p-5 lg:col-span-2">
          ...
          <article className="bento-card p-5 lg:col-span-1">
            <div className="mb-3 flex items-center gap-2 text-foreground">
